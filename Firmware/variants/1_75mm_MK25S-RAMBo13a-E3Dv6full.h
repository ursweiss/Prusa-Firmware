...
// Printer name
#define CUSTOM_MENDEL_NAME "Prusa i3 MK2.5S - Custom"
...
#define DEFAULT_PWM_MOTOR_CURRENT  {540, 850, 550} // {XY,Z,E}
#define DEFAULT_PWM_MOTOR_CURRENT_LOUD  {590, 850, 600} // {XY,Z,E}
#define Z_SILENT 0
